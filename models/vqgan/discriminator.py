...
class Discriminator(nn.Module):
    ...
    def __init__(self, args, is_mask=False, num_filters_last=64, n_layers=3, norm_layer=nn.BatchNorm2d):
        ...
        kernel_size = 4
        padding_size = 1
        image_channels = args.image_channels if not is_mask else 4
        sequence = [nn.Conv2d(image_channels, num_filters_last, kernel_size, stride=2, padding=padding_size),
                    nn.LeakyReLU(0.2)]
        num_filters_mult = 1
